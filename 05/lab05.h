...
class Rational
{
 public:
  ...
  istream& read(istream& is);                     // Read Rational from input
                                                  //   stream
  bool isEqualTo(const Rational& other) const;    // *this == other
  bool isNotEqualTo(const Rational& other) const; // *this != other
  bool isLessThan(const Rational& other) const;   // *this < other
  bool isLessThanOrEqualTo(const Rational& other) const; // *this <= other
  bool isGreaterThan(const Rational& other) const; // *this > other
  bool isGreaterThanOrEqualTo(const Rational& other) const; // *this >= other
 private:
